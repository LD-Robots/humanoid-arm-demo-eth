...
inline std::string to_yaml(const GetSdo_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use ethercat_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const ethercat_msgs::srv::GetSdo_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  ethercat_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use ethercat_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const ethercat_msgs::srv::GetSdo_Event & msg)
{
  return ethercat_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<ethercat_msgs::srv::GetSdo_Event>()
{
  return "ethercat_msgs::srv::GetSdo_Event";
}

template<>
inline const char * name<ethercat_msgs::srv::GetSdo_Event>()
{
  return "ethercat_msgs/srv/GetSdo_Event";
}

template<>
struct has_fixed_size<ethercat_msgs::srv::GetSdo_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<ethercat_msgs::srv::GetSdo_Event>
  : std::integral_constant<bool, has_bounded_size<ethercat_msgs::srv::GetSdo_Request>::value && has_bounded_size<ethercat_msgs::srv::GetSdo_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<ethercat_msgs::srv::GetSdo_Event>
  : std::true_type {};
