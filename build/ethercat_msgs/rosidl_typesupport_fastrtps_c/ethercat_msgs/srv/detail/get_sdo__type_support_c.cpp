...
bool cdr_serialize_ethercat_msgs__srv__GetSdo_Request(
  const ethercat_msgs__srv__GetSdo_Request * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ethercat_msgs
bool cdr_deserialize_ethercat_msgs__srv__GetSdo_Request(
  eprosima::fastcdr::Cdr & cdr,
  ethercat_msgs__srv__GetSdo_Request * ros_message)
{
  // Field name: master_id
  {
    cdr >> ros_message->master_id;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ethercat_msgs
bool cdr_serialize_key_ethercat_msgs__srv__GetSdo_Request(
  const ethercat_msgs__srv__GetSdo_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: master_id
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ethercat_msgs
size_t get_serialized_size_key_ethercat_msgs__srv__GetSdo_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetSdo_Request__ros_msg_type * ros_message = static_cast<const _GetSdo_Request__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ethercat_msgs
size_t max_serialized_size_key_ethercat_msgs__srv__GetSdo_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ethercat_msgs__srv__GetSdo_Request * ros_message = static_cast<const ethercat_msgs__srv__GetSdo_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ethercat_msgs__srv__GetSdo_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ethercat_msgs__srv__GetSdo_Request * ros_message = static_cast<ethercat_msgs__srv__GetSdo_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ethercat_msgs__srv__GetSdo_Request(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ethercat_msgs
bool cdr_serialize_ethercat_msgs__srv__GetSdo_Response(
  const ethercat_msgs__srv__GetSdo_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: success
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ethercat_msgs
bool cdr_deserialize_ethercat_msgs__srv__GetSdo_Response(
  eprosima::fastcdr::Cdr & cdr,
  ethercat_msgs__srv__GetSdo_Response * ros_message)
{
  // Field name: success
  {
    uint8_t tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ethercat_msgs
bool cdr_serialize_key_ethercat_msgs__srv__GetSdo_Response(
  const ethercat_msgs__srv__GetSdo_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: success
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ethercat_msgs
size_t get_serialized_size_key_ethercat_msgs__srv__GetSdo_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetSdo_Response__ros_msg_type * ros_message = static_cast<const _GetSdo_Response__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ethercat_msgs
size_t max_serialized_size_key_ethercat_msgs__srv__GetSdo_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ethercat_msgs__srv__GetSdo_Response * ros_message = static_cast<const ethercat_msgs__srv__GetSdo_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ethercat_msgs__srv__GetSdo_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ethercat_msgs__srv__GetSdo_Response * ros_message = static_cast<ethercat_msgs__srv__GetSdo_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ethercat_msgs__srv__GetSdo_Response(cdr, ros_message);
}
...
using _GetSdo_Event__ros_msg_type = ethercat_msgs__srv__GetSdo_Event;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ethercat_msgs
bool cdr_serialize_ethercat_msgs__srv__GetSdo_Event(
  const ethercat_msgs__srv__GetSdo_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_ethercat_msgs__srv__GetSdo_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_ethercat_msgs__srv__GetSdo_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ethercat_msgs
bool cdr_deserialize_ethercat_msgs__srv__GetSdo_Event(
  eprosima::fastcdr::Cdr & cdr,
  ethercat_msgs__srv__GetSdo_Event * ros_message)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      ethercat_msgs__srv__GetSdo_Request__Sequence__fini(&ros_message->request);
    }
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_ethercat_msgs__srv__GetSdo_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      ethercat_msgs__srv__GetSdo_Response__Sequence__fini(&ros_message->response);
    }
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_ethercat_msgs__srv__GetSdo_Response(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ethercat_msgs
size_t get_serialized_size_ethercat_msgs__srv__GetSdo_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetSdo_Event__ros_msg_type * ros_message = static_cast<const _GetSdo_Event__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  size_t initial_alignment = current_alignment;
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ethercat_msgs__srv__GetSdo_Request(
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ethercat_msgs__srv__GetSdo_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ethercat_msgs
size_t max_serialized_size_ethercat_msgs__srv__GetSdo_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ethercat_msgs__srv__GetSdo_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ethercat_msgs__srv__GetSdo_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ethercat_msgs__srv__GetSdo_Event;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ethercat_msgs
bool cdr_serialize_key_ethercat_msgs__srv__GetSdo_Event(
  const ethercat_msgs__srv__GetSdo_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_ethercat_msgs__srv__GetSdo_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_ethercat_msgs__srv__GetSdo_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ethercat_msgs
size_t get_serialized_size_key_ethercat_msgs__srv__GetSdo_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetSdo_Event__ros_msg_type * ros_message = static_cast<const _GetSdo_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_ethercat_msgs__srv__GetSdo_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_ethercat_msgs__srv__GetSdo_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ethercat_msgs
size_t max_serialized_size_key_ethercat_msgs__srv__GetSdo_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ethercat_msgs__srv__GetSdo_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ethercat_msgs__srv__GetSdo_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static bool _GetSdo_Event__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  if (!untyped_ros_message) {
  ...
  const ethercat_msgs__srv__GetSdo_Event * ros_message = static_cast<const ethercat_msgs__srv__GetSdo_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ethercat_msgs__srv__GetSdo_Event(ros_message, cdr);
}

static bool _GetSdo_Event__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  if (!untyped_ros_message) {
  ...
  ethercat_msgs__srv__GetSdo_Event * ros_message = static_cast<ethercat_msgs__srv__GetSdo_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ethercat_msgs__srv__GetSdo_Event(cdr, ros_message);
}

static uint32_t _GetSdo_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ethercat_msgs__srv__GetSdo_Event(
      untyped_ros_message, 0));
}

static size_t _GetSdo_Event__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ethercat_msgs__srv__GetSdo_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_GetSdo_Event = {
  "ethercat_msgs::srv",
  "GetSdo_Event",
  _GetSdo_Event__cdr_serialize,
  _GetSdo_Event__cdr_deserialize,
  _GetSdo_Event__get_serialized_size,
  _GetSdo_Event__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _GetSdo_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GetSdo_Event,
  get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ethercat_msgs, srv, GetSdo_Event)() {
  return &_GetSdo_Event__type_support;
}
...
static rosidl_service_type_support_t GetSdo__handle = {
  ...
  &_GetSdo_Request__type_support,
  &_GetSdo_Response__type_support,
  &_GetSdo_Event__type_support,
