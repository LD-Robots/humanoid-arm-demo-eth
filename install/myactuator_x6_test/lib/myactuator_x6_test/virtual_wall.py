...
class VirtualWallNode(Node):
    def __init__(self):
        ...
        # Declare parameters
        self.declare_parameter('joints', ['motor0_joint', 'motor1_joint'])
        self.declare_parameter('lower_limits', [3.19995, -1.5708])  # Per-joint lower limits
        self.declare_parameter('upper_limits', [-0.996385, 4.0])    # Per-joint upper limits
        self.declare_parameter('soft_limit_margin', 0.1)            # Margin before hard limit
        self.declare_parameter('wall_stiffness', 20.0)              # Nm/rad
        self.declare_parameter('wall_damping', 0.1)                 # Nm/(rad/s)
        self.declare_parameter('max_wall_torque', 3.0)              # Nm
