"""
MoveIt launcher for MyActuator Arm

Requires arm_base.launch.py to be running first!

This launcher:
1. Switches from free-floating to trajectory controller
2. Launches MoveIt move_group and RViz
3. Stays running until Ctrl+C
4. On shutdown, switches back to free-floating (safe mode)
